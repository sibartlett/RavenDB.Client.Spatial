...
using Raven.Client.Spatial.NetTopologySuite;
using Xunit;

namespace Raven.Client.Spatial.Tests.Nts
{
	public class GeoJsonTests : SpatialTestBase
	{
		...
		//public void Feature()
		//{
		//	Exception ex = Assert.Throws<NotImplementedException>(() =>
		//	{
		//		Assertion<Feature>(() => new Feature(new Point(56.543, 32.657), new AttributesTable()));
		//	});
		//}
	}
}